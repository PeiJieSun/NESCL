...
def create_dataset(config, pre_flag=0, pre_field2id_token=None, pre_field2token_id=None):
    ...
    if hasattr(dataset_module, config['model'] + 'Dataset'):
        ...
        if model_type == ModelType.SEQUENTIAL:
            ...
            return Dataset(config, pre_flag, pre_field2id_token, pre_field2token_id)

def create_dataset_x(config, pre_flag=0, pre_field2id_token=None, pre_field2token_id=None):
    """Create dataset according to :attr:`config['model']` and :attr:`config['MODEL_TYPE']`.
    ...
    if hasattr(dataset_module, config['model'] + 'Dataset'):
        ...
        if model_type == ModelType.SEQUENTIAL:
            ...
            return Dataset_X(config, pre_flag, pre_field2id_token, pre_field2token_id)
