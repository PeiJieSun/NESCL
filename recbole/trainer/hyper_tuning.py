...
class HyperTuning(object):
    ...
    def __init__(
        ...
        self.suffix = self.generate_random_string()
    ...
    def trial(self, params):
        ...
        result_dict = self.objective_function(config_dict, self.fixed_config_file_list, suffix=self.suffix)
    ...
    def generate_random_string(self):
        ...
        print('The suffix of the tensorboard is:%s' % res)
        return res